...
(() => {
    ...
    */
    ...
    function displayAboutPage() {
        ...
        let About = document.getElementById("about-tom-pic");
        let AboutT = document.getElementById("about-tom-content");
        let pic = document.createElement("img");
        pic.setAttribute("class", "image-responsive");
