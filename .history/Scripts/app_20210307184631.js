    ...
    function textNameValidation()
    {
      ...
      $("#firstName").on("blur", function(){
        if ($(this).val().length < nameMinChars) {
          ...
          errorMessage.show().addClass("alert alert-danger").append("Please Enter a valid First Name, must be greater than 2 Characters");
        } else {
          errorMessage.removeAttr("class").hide();
        }
      });
      ...
      $("#lastName").on("blur", function(){
        if ($(this).val().length < nameMinChars) {
          ...
          errorMessage.show().addClass("alert alert-danger").append("Please Enter a valid Last Name, must be greater than 2 Characters");
        } else {
          errorMessage.removeAttr("class").hide();
        }
      });
