...
(() => {
    ...
    */
    ...
    function fixNavBars()
    {
        let navBarItemList = document.getElementsByClassName

        // Fix the "Products" Nav item
        let projectPageAnchor = document.getElementsByTagName("ul");    // Get the Nav item Anchor tag by id
        ...
        navBarItemList.appendChild(humanResourcesListItem);
