...
(() => {
    ...
    */
    ...
    function displayAboutPage() {
        ...
        let calvinPortraitArea = document.getElementById("calvin-portrait-zone");
        let calvinPortrait = document.createElement("img");
        calvinPortrait.setAttribute("src", "../Pictures/Tom.jpeg");
        calvinPortrait.setAttribute("height", "200");
        calvinPortrait.setAttribute("width", "200");
        calvinPortrait.setAttribute("border-radius", "50");
        calvinPortrait.setAttribute("alt", "Headshot of Tom");

        calvinPortraitArea.appendChild(calvinPortrait);
    }
