...
If you want to look at some of my Projects feel free to look at my GitHub<a class="nav-link" href="https://github.com/Tomelinski?tab=repositories">GitHub</a>
    ...
    function displayServicesPage() {
        ...
        //-About project Info
        aboutServiceOne.innerHTML = `<hr/><p>This is our poject of recreating the famous Snack game in C#. We utilized enum's and a variety of functions to make it function exactly like the real snake game</p>`;
        ...
        //-About project Info
        aboutServiceTwo.innerHTML = `<hr/><p>This is our poject of recreating the famous Snack game in C#. We utilized enum's and a variety of functions to make it function exactly like the real snake game</p>`;
        ...
        //-About project Info
        aboutServiceThree.innerHTML = `<hr/><p>This is our poject of recreating the famous Snack game in C#. We utilized enum's and a variety of functions to make it function exactly like the real snake game</p>`;
