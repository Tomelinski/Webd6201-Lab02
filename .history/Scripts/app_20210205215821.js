...
If you want to look at some of my Projects feel free to look at my GitHub<a class="nav-link" href="https://github.com/Tomelinski?tab=repositories">GitHub</a>
    ...
    function displayServicesPage() {
        ...
        // Set the Attributes, html, and Content for project 1 Elements
        //-Name Heading
        serviceOneHeading.textContent = "Snake Game Project"; 
        //-Portrait
        serviceOnePic.setAttribute("src", "../Pictures/service_webdev.jpg");
        serviceOnePic.setAttribute("class", "serviceOnePic");
        serviceOnePic.setAttribute("alt", "Snake project");   

        //-About project Info
        aboutServiceOne.innerHTML = `<p>This is our poject of recreating the famous Snack game in C#. We utilized enum's and a variety of functions to make it function exactly like the real snake game</p>`;
        ...
        // Set the Attributes, html, and Content for project 1 Elements
        //-Name Heading
        serviceTwoHeading.textContent = "Snake Game Project"; 
        //-Portrait
        serviceTwoPic.setAttribute("src", "../Pictures/service_webdev.jpg");
        serviceTwoPic.setAttribute("class", "serviceOnePic");
        serviceTwoPic.setAttribute("alt", "Snake project");   

        //-About project Info
        aboutServiceTwo.innerHTML = `<p>This is our poject of recreating the famous Snack game in C#. We utilized enum's and a variety of functions to make it function exactly like the real snake game</p>`;
        ...
        // Set the Attributes, html, and Content for project 1 Elements
        //-Name Heading
        serviceThreeHeading.textContent = "Snake Game Project"; 
        //-Portrait
        serviceThreePic.setAttribute("src", "../Pictures/service_webdev.jpg");
        serviceThreePic.setAttribute("class", "serviceOnePic");
        serviceThreePic.setAttribute("alt", "Snake project");   

        //-About project Info
        aboutServiceThree.innerHTML = `<p>This is our poject of recreating the famous Snack game in C#. We utilized enum's and a variety of functions to make it function exactly like the real snake game</p>`;
