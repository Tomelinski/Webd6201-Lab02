...
(() => {
    ...
    */
    ...
    function displayAboutPage() {
        ...
        let introductionHeading = document.createElement("h3");
        ...
        About.appendChild(tomHeading);
        About.appendChild(aboutTom);

        let calvinAbout = document.getElementById("about-calvin");
        ...
        calvinAbout.appendChild(calvinPortrait);
    }
