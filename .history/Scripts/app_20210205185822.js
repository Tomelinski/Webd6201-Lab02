...
(() => {
    ...
    */
    ...
    function displayAboutPage() {
        ...
        let tomResumeHeading = document.createElement("h3");
        ...
        tomResumeHeading.textContent = "Resume";
        ...
        aboutTomDiv.appendChild(tomResumeHeading);
        ...
        let calvinResumeHeading = document.createElement("h3");
        ...
        calvinPortrait.setAttribute("src", "../Pictures/Calvin.jpeg");
        calvinPortrait.setAttribute("class", "headshot-portrait");
        calvinPortrait.setAttribute("alt", "Headshot of Tom");
        aboutCalvin.innerHTML = `</br><p>Hello, My name is Tom Zielinski. I am a second year student at Durham College enrolled in the Computer Programming & Analysis program.</p>`;       
        calvinResumeHeading.textContent = "Resume"; 
        
        // Insert the Elements within the about-tom div
        aboutCalvinDiv.appendChild(calvinPortrait);
        aboutCalvinDiv.appendChild(calvinHeading);
        aboutCalvinDiv.appendChild(aboutCalvin);
        aboutCalvinDiv.appendChild(calvinResumeHeading);
    }
