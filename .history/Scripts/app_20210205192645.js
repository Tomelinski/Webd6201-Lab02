...
(() => {
    ...
    */
    ...
    function displayAboutPage() {
        ...
        tomResume.setAttribute("class", "btn btn-primary p-1 bg-primary text-white rounded rounded-2 navbar-brand");
        ...
        aboutCalvin.innerHTML = `<hr/><p>Hello, My name is Tom Zielinski. I am a second year student at Durham College enrolled in the Computer Programming & Analysis program.</p>`;       
